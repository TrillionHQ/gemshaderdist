...
function processModelAssets() {
  ...
  ringMesh.traverse((child) => {
    ...
    if (lcName.indexOf("diamond") > -1) {
      ...
      child.material.dispersion = 0.75;
...
//# sourceMappingURL=diamondonly_physical-CsO7DjBk.js.map
