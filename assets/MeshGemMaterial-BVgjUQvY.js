import { t as getTriCount, u as FLOAT32_EPSILON, v as CENTER, w as AVERAGE, s as SAH, x as TRIANGLE_INTERSECT_COST, y as TRAVERSAL_COST, z as BYTES_PER_NODE, J as IS_LEAF, K as IS_LEAFNODE_FLAG, L as hasGroupGaps, N as ensureIndex, Q as getFullGeometryRange, R as getRootIndexRanges, a as Vector3, V as Vector2, U as Plane, X as Line3, Y as Triangle, Z as Sphere, _ as Matrix4, $ as OFFSET, a0 as COUNT, a1 as BOUNDING_DATA_INDEX, a2 as RIGHT_NODE, a3 as CONTAINED, a4 as Box3, a5 as LEFT_NODE, B as BackSide, D as DoubleSide, a6 as SPLIT_AXIS, a7 as SKIP_GENERATION, a8 as BufferAttribute, F as FrontSide, a9 as shaderIntersectFunction, M as MeshPhysicalMaterial, r as MeshBVHUniformStruct, aa as shaderStructs } from "./MeshRefractionMaterial-BmDKIvBb.js";
...
//   #include <cube_uv_reflection_fragment>
  ...
  vec4 getTotalInternalReflection() {
    ...
    vec3 finalColor;
      ...
      #endif
      float finalColorR = textureGradient(envMapD, rayDirectionR, directionCamPerfect).r;
      float finalColorG = textureGradient(envMapD, rayDirectionG, directionCamPerfect).g;
      float finalColorB = textureGradient(envMapD, rayDirectionB, directionCamPerfect).b;
      finalColor = vec3(finalColorR, finalColorG, finalColorB) * envMapIntensity;
    //   finalColor = vec3(uv, 0.);
    // finalColor = texture2D(envMapD, uv).xyz;
    ...
    //   if (true) {
        ...
        finalColor = textureGradient(envMapD, rayDirection, directionCamPerfect).rgb * envMapIntensity;
      }
      #else
      finalColor = textureGradient(envMapD, rayDirection, directionCamPerfect).rgb * envMapIntensity;
...
class MeshGemMaterial extends MeshPhysicalMaterial {
  constructor(cfg) {
    super();
...
export {
  MeshGemMaterial as M,
  MeshBVH as a
};
//# sourceMappingURL=MeshGemMaterial-BVgjUQvY.js.map
